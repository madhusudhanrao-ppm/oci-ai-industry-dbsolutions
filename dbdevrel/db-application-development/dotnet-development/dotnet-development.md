...
6.  Install the .NET Core SDK
      ...
      [Download and install .NET Core SDK](https://dotnet.microsoft.com/en-us/download) 3.1 or higher. Click the Install button to install the extension.

      ![Dotnet SDK Installation](images/dot-net-install.png =30%x* "Dotnet SDK Installation")  
...
2. Run **dotnet new console** from the command line to create a new project.
      ...
      ![dotnet new console](images/console.png "dotnet new console")
...
7. Execute the app by running **dotnet run** from the command line. You should see the customers sample data
      ...
      ![Sample Code run](images/dotnetrun.png)
